...
public class GuiConfig {
    ...
    private void loadConfig() {
        ...
        if (phoneGui != null) {
            ...
            if (nav != null) {
                ...
                if (left != null) {
                    navLeftSlot = left.getInt("slot", 46);
                ...
                if (right != null) {
                    navRightSlot = right.getInt("slot", 52);
    ...
    // Phone GUI gettery
    public String getPhoneGuiTitle() { return phoneGuiTitle; }
    public String getNexoTitle() { return nexoTitle; }
    public boolean useNexo() { return nexoTitle != null && !nexoTitle.isEmpty(); }
    public String getEffectiveTitle() { return useNexo() ? nexoTitle : phoneGuiTitle; }
    public int getPhoneGuiSize() { return phoneGuiSize; }
    public List<Integer> getFrameSlots() { return frameSlots != null ? frameSlots : new ArrayList<>(); }
    public Material getFrameMaterial() { return frameMaterial; }
    public int getFrameCustomModelData() { return frameCustomModelData; }
    public String getFrameDisplayName() { return frameDisplayName; }
    public List<Integer> getScreenSlots() { return screenSlots != null ? screenSlots : new ArrayList<>(); }
    public Material getScreenBackgroundMaterial() { return screenBackgroundMaterial; }
    public int getScreenBackgroundCustomModelData() { return screenBackgroundCustomModelData; }
    public String getScreenBackgroundDisplayName() { return screenBackgroundDisplayName; }

    public int getNavLeftSlot() { return navLeftSlot; }
    public Material getNavLeftMaterial() { return navLeftMaterial; }
    public String getNavLeftDisplayName() { return navLeftDisplayName; }
    public List<String> getNavLeftLore() { return navLeftLore != null ? navLeftLore : new ArrayList<>(); }
    public int getNavHomeSlot() { return navHomeSlot; }
    public Material getNavHomeMaterial() { return navHomeMaterial; }
    public String getNavHomeDisplayName() { return navHomeDisplayName; }
    public List<String> getNavHomeLore() { return navHomeLore != null ? navHomeLore : new ArrayList<>(); }
    public int getNavRightSlot() { return navRightSlot; }
    public Material getNavRightMaterial() { return navRightMaterial; }
    public String getNavRightDisplayName() { return navRightDisplayName; }
    public List<String> getNavRightLore() { return navRightLore != null ? navRightLore : new ArrayList<>(); }

    // Contacts GUI gettery
    public String getContactsGuiTitle() { return contactsGuiTitle; }
    public int getContactsGuiSize() { return contactsGuiSize; }
    public int getContactsAddButtonSlot() { return contactsAddButtonSlot; }
    public Material getContactsAddButtonMaterial() { return contactsAddButtonMaterial; }
    public String getContactsAddButtonDisplayName() { return contactsAddButtonDisplayName; }

    // SMS GUI gettery
    public String getSmsGuiTitle() { return smsGuiTitle; }
    public int getSmsGuiSize() { return smsGuiSize; }
    public int getSmsComposeButtonSlot() { return smsComposeButtonSlot; }
    public Material getSmsComposeButtonMaterial() { return smsComposeButtonMaterial; }
    public String getSmsComposeButtonDisplayName() { return smsComposeButtonDisplayName; }
    public String getSmsConversationsGuiTitle() { return smsConversationsGuiTitle; }
    public int getSmsConversationsGuiSize() { return smsConversationsGuiSize; }

    // AppStore GUI gettery
    public String getAppstoreGuiTitle() { return appstoreGuiTitle; }
    public int getAppstoreGuiSize() { return appstoreGuiSize; }

    // Settings GUI gettery
    public String getSettingsGuiTitle() { return settingsGuiTitle; }
    public int getSettingsGuiSize() { return settingsGuiSize; }

    // SIM Shop GUI gettery
    public String getSimShopGuiTitle() { return simShopGuiTitle; }
    public int getSimShopGuiSize() { return simShopGuiSize; }
}
